...
const paths: Record<IconName, string[]> = {
  ...
  down: ['M12 18l-6-6', 'M12 18l6-6', 'M12 18V6'],
  ...
  link: ['M9.5 14.5l-1.1 1.1a3.5 3.5 0 0 1-5-5l2.2-2.2a3.5 3.5 0 0 1 4.9 0', 'M14.5 9.5l1.1-1.1a3.5 3.5 0 0 1 5 5l-2.2 2.2a3.5 3.5 0 0 1-4.9 0', 'M8.5 15.5l7-7'],
  ...
  unlink: ['M9.5 14.5l-1.1 1.1a3.5 3.5 0 0 1-5-5l2.2-2.2a3.5 3.5 0 0 1 4.9 0', 'M14.5 9.5l1.1-1.1a3.5 3.5 0 0 1 5 5l-2.2 2.2a3.5 3.5 0 0 1-4.9 0', 'M8 16l8-8'],
  up: ['M12 6l-6 6', 'M12 6l6 6', 'M12 6v12'],
};
